...
class Authen with ChangeNotifier {
  ...
  Future<void> signup(String email, String password) async {
    Uri url = Uri.parse(
        "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyCUUMzslZVRvRiknVdu14vJXSnNmopW3XM");
  ...
  Future<void> login(String email, String password) async {
    Uri url = Uri.parse(
        "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyCUUMzslZVRvRiknVdu14vJXSnNmopW3XM");
    try {
      var response = await http.post(
        url,
        body: json.encode(
